...
<style>
  ...
  #aboutUs-text {
      margin: 22rem 13rem 0.5rem 13rem;
      font-size: 1.3rem;
      line-height: 2.1rem;
  }
...
<img src="../imgs/img5.jpg" id="bg-img">
    <main id="aboutUs-text">
        ...
        <p>BloodLink's mission is to make it easy for people to find and connect with blood donors in their area. We believe that everyone deserves access to safe and reliable blood transfusions, and we are committed to making it easier for people to find the blood they need.</p>
    </main>
<?php
